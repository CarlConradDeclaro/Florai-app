    ...
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <Text  className={focused ? 'text-green-500 font-bold ' : 'text-gray-400  '} >Home</Text>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <Text  className={focused ? 'text-green-500 font-bold' : 'text-gray-400'} >Explore</Text>
          ),
        }}
      />
     ...
     <Tabs.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <Text  className={focused ? 'text-green-500 font-bold' : 'text-gray-500'} >Scan</Text>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <Text  className={focused ? 'text-green-500 font-bold' : 'text-gray-500'} >Saved</Text>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <Text  className={focused ? 'text-green-500 font-bold' : 'text-gray-500'} >Profile</Text>
          ),
        }}
      />
...
const TabIcon = ({ imagePath }: { imagePath: string }) => {
  ...
  return (
    <Image
      source={isRemote ? { uri: imagePath } : localIcons[imagePath] || localIcons.home} // Default to home.png if not found
      style={{
        width: 24,
        height: 24,
      }}
